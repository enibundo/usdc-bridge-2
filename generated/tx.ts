  ...
  fromJSON(object: any): MsgEnableAttester {
    return {
      ...
      attester: isSet(object.attester)
        ? globalThis.String(object.attester)
        : "",
    };
  },
...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.PauseSendingAndReceivingMessages =
      this.PauseSendingAndReceivingMessages.bind(this);
    this.ReceiveMessage = this.ReceiveMessage.bind(this);
    this.RemoveRemoteTokenMessenger =
      this.RemoveRemoteTokenMessenger.bind(this);
    ...
    this.UnpauseSendingAndReceivingMessages =
      this.UnpauseSendingAndReceivingMessages.bind(this);
    ...
    this.SetMaxBurnAmountPerMessage =
      this.SetMaxBurnAmountPerMessage.bind(this);
  ...
  AcceptOwner(request: MsgAcceptOwner): Promise<MsgAcceptOwnerResponse> {
    ...
    return promise.then((data) =>
      MsgAcceptOwnerResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  DepositForBurn(
    ...
    return promise.then((data) =>
      MsgDepositForBurnResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  DisableAttester(
    ...
    return promise.then((data) =>
      MsgDisableAttesterResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  EnableAttester(
    ...
    return promise.then((data) =>
      MsgEnableAttesterResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  LinkTokenPair(request: MsgLinkTokenPair): Promise<MsgLinkTokenPairResponse> {
    ...
    return promise.then((data) =>
      MsgLinkTokenPairResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  PauseSendingAndReceivingMessages(
    ...
    return promise.then((data) =>
      MsgPauseSendingAndReceivingMessagesResponse.decode(
  ...
  ReceiveMessage(
    ...
    return promise.then((data) =>
      MsgReceiveMessageResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  ReplaceDepositForBurn(
    ...
    return promise.then((data) =>
      MsgReplaceDepositForBurnResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  ReplaceMessage(
    ...
    return promise.then((data) =>
      MsgReplaceMessageResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  SendMessage(request: MsgSendMessage): Promise<MsgSendMessageResponse> {
    ...
    return promise.then((data) =>
      MsgSendMessageResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  SendMessageWithCaller(
    ...
    return promise.then((data) =>
      MsgSendMessageWithCallerResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  UnlinkTokenPair(
    ...
    return promise.then((data) =>
      MsgUnlinkTokenPairResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  UnpauseSendingAndReceivingMessages(
    ...
    return promise.then((data) =>
      MsgUnpauseSendingAndReceivingMessagesResponse.decode(
        _m0.Reader.create(data)
      )
    );
  }
  ...
  UpdateOwner(request: MsgUpdateOwner): Promise<MsgUpdateOwnerResponse> {
    ...
    return promise.then((data) =>
      MsgUpdateOwnerResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  UpdateAttesterManager(
    ...
    return promise.then((data) =>
      MsgUpdateAttesterManagerResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  UpdateTokenController(
    ...
    return promise.then((data) =>
      MsgUpdateTokenControllerResponse.decode(_m0.Reader.create(data))
    );
  }
  ...
  UpdatePauser(request: MsgUpdatePauser): Promise<MsgUpdatePauserResponse> {
    ...
    return promise.then((data) =>
      MsgUpdatePauserResponse.decode(_m0.Reader.create(data))
    );
  }
